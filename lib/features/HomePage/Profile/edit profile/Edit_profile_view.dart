...
class EditProfileView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    EditprofileController.fullnameController.text='Dohaa ayman';
    EditprofileController.passwordController.text='123456';
    EditprofileController.emailController.text='dohaslam@gmail.com';
    return Scaffold(
