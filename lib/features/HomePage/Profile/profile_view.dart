...
import '../../Extra_Features/booking_confirmation_screen.dart';
import '../../Extra_Features/feedback_screen.dart';
import '../../Extra_Features/reschedule_cancel_screen.dart';
import '../../map_screen/maps.dart';
import 'edit profile/ChangePassword/changepasswordhome.dart';
...
var settings_options = [
  ...
  },
  {
    ...
    'color': ColorsManger.darkblue,
    'function': () {
      Get.to(() => BookingConfirmationScreen(service: 'Tyre Wash', date: '12/5/2023', time: '3.00 pm',));
    }
  },
  {
    'icon': FaIcon(
        ...
        RPadding(
          ...
          child: Row(children: [
            ...
            Column(
              ...
              children: [
                Text(
                  'Dohaa ayman', // This should update automatically
                  style:
